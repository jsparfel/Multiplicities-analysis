...
int main(int argc, char **argv)
{
  ...
  {
    ifstream DIS_file1(Form("%s/%d/DIS/DIS_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream DIS_zvtx_file1(Form("%s/%d/DIS/DIS_zvtx_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream had_file1(Form("%s/%d/hadron/hadron_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream had_zvtx_file1(Form("%s/%d/hadron/hadron_zvtx_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream had_theta_file1(Form("%s/%d/hadron/hadron_theta_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream had_pt_file1(Form("%s/%d/hadron/hadron_pt_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream electron_file1(Form("%s/%d/electron/electron_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream electron_zvtx_file1(Form("%s/%d/electron/electron_zvtx_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream electron_theta_file1(Form("%s/%d/electron/electron_theta_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream electron_pt_file1(Form("%s/%d/electron/electron_pt_%s.txt",filename.c_str(),year,periodName.c_str()));
  ...
  {
    ifstream DIS_file2(Form("%s/%d/DIS/DIS_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream DIS_zvtx_file2(Form("%s/%d/DIS/DIS_zvtx_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream had_file2(Form("%s/%d/hadron/hadron_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream had_zvtx_file2(Form("%s/%d/hadron/hadron_zvtx_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream had_theta_file2(Form("%s/%d/hadron/hadron_theta_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream had_pt_file2(Form("%s/%d/hadron/hadron_pt_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream electron_file2(Form("%s/%d/electron/electron_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream electron_zvtx_file2(Form("%s/%d/electron/electron_zvtx_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream electron_theta_file2(Form("%s/%d/electron/electron_theta_%s.txt",filename.c_str(),year,periodName.c_str()));
    ifstream electron_pt_file2(Form("%s/%d/electron/electron_pt_%s.txt",filename.c_str(),year,periodName.c_str()));
