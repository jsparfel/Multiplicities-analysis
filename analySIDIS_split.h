...
vector<Float_t> fHL04x;
vector<Float_t> fHL04y;
vector<Float_t> fHL05x;
vector<Float_t> fHL05y;
vector<Float_t> fHG01x;
vector<Float_t> fHG01y;
vector<Float_t> fHG021x;
vector<Float_t> fHG021y;
vector<Float_t> fHG022x;
vector<Float_t> fHG022y;
vector<bool>     fSaved;
...
TCanvas c101("HM04","HM04");
TCanvas c102("HM05","HM05");
TCanvas c103("HL04","HL04");
TCanvas c104("HL05","HL05");
TCanvas c105("HG01","HG01");
TCanvas c106("HG021","HG021");
TCanvas c107("HG022","HG022");
